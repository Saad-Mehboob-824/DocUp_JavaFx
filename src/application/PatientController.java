...
//
//    @FXML
//    private TextField Update_AppTime;//After Searching for Update appointment it displays the Appointment Time here and updates the id when update button is pressed
//
//
//    @FXML
//    private TextField Update_DocID;//After Searching for Update appointment it displays the Doctor id here and updates the id when update button is pressed
//
//    @FXML
//    private Button Update_app;
//
...
////}
//////--------------UPDATE
////Patient p4 = new Patient(1, "7385", "Subhan", "776756392384", "STOMACHACE");
////try {
...
////Doctor d2 = new Doctor(2, "1234", "John Doe", "1234567890123", "Cardiology");
////try {
////	Docdao.addDoctor(d2);
////} catch (SQLException e) {
////    e.printStackTrace();
...
////Doctor d4 = new Doctor(123, "7385", "Jane Doe", "9876543210987", "Neurology");
////try {
